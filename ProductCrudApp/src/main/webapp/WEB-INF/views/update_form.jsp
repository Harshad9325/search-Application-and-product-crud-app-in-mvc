		...
		<div class="container ">
				...
				<div class="row">
					<div class="col-md-6 offset-md-3">
						<h1  style="color: #0dcaf0; font-family:poppins"; class="text-center mb-3">Change Product Details</h1>
						<form action="${pageContext.request.contextPath }/handle-product"
							method="post">

							<input type="hidden" value="${product.id }" name="id">
							<div class="form-group">
								<label style="color: white;" for="name">Product Name</label> <input type="text"
							...
							<div class="form-group">
								<label style="color: white; for="price">Product Price</label> <input type="text"
